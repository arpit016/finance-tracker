class UserStocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if params[:stock_id].present?
        stock_already_exist = UserStock.all.where(user_id:current_user.id, stock_id:params[:stock_id])
        if stock_already_exist
          format.html { redirect_to my_portfolio_path, notice: "Stock #{@user_stock.stock.ticker} was successfully found."}
